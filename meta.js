...
const META_BUILDS = [
  { id: "work-noct", cat: "work", titre: "Ouvrier maximal (pal nocturne)", icone: "hammer",
  ...
  { id: "work-day", cat: "work", titre: "Ouvrier 24 h/24 (pal diurne)", icone: "moon",
  ...
  { id: "work-budget", cat: "work", titre: "Ouvrier accessible (début/milieu de partie)", icone: "wrench",
  ...
  { id: "ranch", cat: "work", titre: "Pal de ranch", icone: "egg",
  ...
  { id: "breed", cat: "work", titre: "Parents reproducteurs", icone: "heart2",
  ...
  { id: "combat", cat: "fight", titre: "Combat polyvalent", icone: "sword",
  ...
  { id: "burst", cat: "fight", titre: "Dégâts maximum (fragile)", icone: "burst",
  ...
  { id: "tank", cat: "fight", titre: "Tank de raid", icone: "shield",
  ...
  { id: "elem", cat: "fight", titre: "Spécialiste élémentaire", icone: "orb",
  ...
  { id: "mount", cat: "mount", titre: "Monture la plus rapide", icone: "horse",
  ...
  { id: "mount-water", cat: "mount", titre: "Monture aquatique", icone: "wave",
    ...
    notes: [] },
  { id: "mount-fight", cat: "mount", titre: "Monture de combat", icone: "horse",
  ...
  { id: "support", cat: "player", titre: "Soutien du joueur (combat)", icone: "medal",
  ...
  { id: "farm", cat: "player", titre: "Soutien récolte", icone: "pick",
...
const META_CATS = { work: "Base & production", fight: "Combat", mount: "Montures", player: "Soutien joueur" };
...
function renderMeta(){
  ...
  document.getElementById("metaList").innerHTML = list.map((b, i) => {
    ...
    return `<div class="metacard" ${reduceMotion ? "" : `style="animation-delay:${i * 40}ms"`}>
      <div class="metahead"><span class="mi">${ico(b.icone,20)}</span>
